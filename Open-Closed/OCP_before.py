...
# What if we want to save the invoice into a database as well???
# Simply modifying class InvoicePersistence and add a new method?
...
# Answer: NOOOOO!! we are violating OCP!
